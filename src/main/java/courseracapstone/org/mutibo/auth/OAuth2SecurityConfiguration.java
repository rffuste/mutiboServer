package courseracapstone.org.mutibo.auth;
 ...
 *
 * 	The resource server is located at "/mutibo", and can be accessed only by retrieving a token from "/oauth/token"
...
public class OAuth2SecurityConfiguration {
	 ...
	 *	resource server (i.e. the "/mutibo" endpoint) 
	 */
	@Configuration
